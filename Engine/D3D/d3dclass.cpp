...
bool D3DClass::Initialize(int screenWidth,int screenHeight,bool vsync,
	...
	MessageBox(hwnd,L"Modes",L"Adapter Modes",MB_OK);
	...
	//////////////////////////////
	//CREATE SWAP CHAIN, D3D DEVICE AND CONTEXT //
	////////////////////////////////////////////
	...
	//Create orthographic projectionmatrix for 2d.
...
//// HELPER FUNCTIONS FOR Initialising Device and Device Context ////
...
void D3DClass::GetVideoCardInformation(char* cardName, int& memory)
{
